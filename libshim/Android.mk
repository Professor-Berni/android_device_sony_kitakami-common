...
LOCAL_MODULE := libaudioclient_shim_sony
...
LOCAL_MODULE := libshims_ims_sony
LOCAL_MODULE_TAGS := optional
LOCAL_MULTILIB := 64
# LOCAL_VENDOR_MODULE := true
...
include $(CLEAR_VARS)
LOCAL_SRC_FILES := ppd_ppoll_shim.cpp
LOCAL_SHARED_LIBRARIES := libdl
LOCAL_MODULE := libppd_ppoll_shim
LOCAL_MODULE_TAGS := optional
LOCAL_MULTILIB := 64
LOCAL_VENDOR_MODULE := true
include $(BUILD_SHARED_LIBRARY)
